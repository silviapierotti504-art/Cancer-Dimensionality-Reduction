---
title: "t-SNE para reducción de dimensiones"
author: "Silvia M. Pierotti"
date: "14/04/2026"
output: 
  html_document:
    toc: true
...
```{r setup_datos, include=TRUE, fig.width=25, fig.height=10, warning=FALSE, message=FALSE, results='hide'}
library(readr)
library(patchwork)
...
```
```{r setup_filtrados, include=TRUE, fig.width=25, fig.height=10, warning=FALSE, message=FALSE, results='hide'}
library(dplyr)
filtrados <- datos %>%
...
**Metodo t-SNE para la reducción de dimensiones y visualización de clusters**

```{r setup_t-SNE, include=TRUE, fig.width=25, fig.height=25, warning=FALSE, message=FALSE, results='hide'}
...
```
**Figura 1**: Resultados del método t-SNE

**Identificacion de los 10 genes con niveles de epresion mas altos en cada cluster**

```{r setup_clusters, include=TRUE, fig.width=25, fig.height=30, warning=FALSE, message=FALSE, results='hide'}
#library(dplyr)
library(tidyr)
#library(ggplot2)
...
**Figura 2**: Para cada cluster se identifican los 20 genes con mayor nivel de expresión. 
